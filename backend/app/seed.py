...
LEDGERS = [
    {
        ...
        "fields": [
            ...
            F("household_type", "户籍类型", "select", False, True, True, ["农业户口", "非农业户口"]),
            F("address", "家庭住址", "text", False, True, True),
            F("photo", "照片", "image", False, False, True),
        ] + COMMON,
    },
    {
    ...
    },
    {
        ...
        "fields": [
            ...
            F("id_card", "身份证号", "text", True, True, True),
            F("phone", "联系电话", "text", False, True, True),
            F("fee_year", "收缴年度", "text", True, True, True),
            ...
            F("amount", "缴费金额", "number", False, True, True),
        ] + COMMON,
    },
    {
